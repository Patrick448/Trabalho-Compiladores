// Generated from /home/patrick/Desktop/Projects/Trabalho-Compiladores/parser/langold.g4 by ANTLR 4.9.2
...
public class langoldParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "langold.g4"; }
	...
	public langoldParser(TokenStream input) {
		super(input);
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			while (_la==ID || _la==INT) {
				...
				setState(14);
				match(T__0);
				 _localctx.ast.addNode(new StmtList(((ProgContext)_localctx).s2.ast.getLine(), ((ProgContext)_localctx).s2.ast.getCol(), ((ProgContext)_localctx).s2.ast));
				}
				}
				setState(21);
				_errHandler.sync(this);
	...
	public static class StmtContext extends ParserRuleContext {
		...
		public StmtContext s1;
		public StmtContext s2;
		public TerminalNode ID() { return getToken(langoldParser.ID, 0); }
		public ExprContext expr() {
	...
	public static class FactorContext extends ParserRuleContext {
		...
		public Token INT;
		public TerminalNode ID() { return getToken(langoldParser.ID, 0); }
		public TerminalNode INT() { return getToken(langoldParser.INT, 0); }

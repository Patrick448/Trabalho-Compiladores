compile: genparser Intepretador.java
	javac -cp .:antlr-4.8-complete.jar:ST-4.3.1.jar Intepretador.java

genparser: parser/lang.g4
	java -jar antlr-4.8-complete.jar parser/lang.g4

run: compile genparser
	java -cp .:antlr-4.8-complete.jar:ST-4.3.1.jar Intepretador $(filter-out $@,$(MAKECMDGOALS))
